...
<head>
    ...
    <link rel="shortcut icon" href="../gambar/Logo-pesat.png" type="image/x-icon">
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>
                    <img src="../gambar/Logo-Pesat.png" height="100px">
                    Data Siswa
                </h1>
                <hr> 
                <a href="index.php" class="btn btn-primnary" style="float: right;">Kembali</a> <br><br>
                </div> 
